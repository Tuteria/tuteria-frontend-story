...
interface FeatureLinkProps extends StackProps {
...
export const links = [
  { label: "GoPay wallet app", href: "#" },
  { label: "GoPay cashout", href: "#" },
  { label: "GoPay debit card", href: "#" },
  { label: "College savings", href: "#" },
