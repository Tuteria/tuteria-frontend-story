    ...
    <Box as="section" bg={useColorModeValue("gray.50", "gray.800")} py="16">
      <Box maxW={{ base: "xl", md: "7xl" }} mx="auto" px="4" pt="12" pb="8">
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing="10">
          ...
          >
            Sed sed risus pretium quam vulputate dignissim. Ornare quam viverra
            orci sagittis. Integer vitae justo eget magna fermentum iaculis eu
            non diam
          </Testimonial>
          <Testimonial
            accentColor="red.500"
          ...
          >
            Vulputate sapien nec sagittis aliquam malesuada bibendum. Posuere
